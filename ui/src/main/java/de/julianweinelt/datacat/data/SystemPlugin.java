...
import de.julianweinelt.datacat.dbx.api.ui.menubar.Menu;
import de.julianweinelt.datacat.dbx.api.ui.menubar.MenuItem;
import de.julianweinelt.datacat.dbx.api.ui.menubar.MenuManager;
import de.julianweinelt.datacat.ui.admin.AdministrationDialog;
...
public final class SystemPlugin extends DbxPlugin {
    ...
    public void init() {
        ...
        getRegistry().registerEvents(this, "UIInitializedEvent");
